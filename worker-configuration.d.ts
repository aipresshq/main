/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: c6d16510930aa8ce28a291e069c1f430)
...
interface __BaseEnv_Env {
	...
	PUBLIC_SUBSTACK_URL: string;
	PRISMIC_WRITE_TOKEN: string;
	GOOGLE_INDEXING_KEY_JSON: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "PUBLIC_R2_PUBLIC_URL" | "R2_ACCOUNT_ID" | "R2_ACCESS_KEY_ID" | "R2_SECRET_ACCESS_KEY" | "R2_BUCKET_NAME" | "PUBLIC_SUBSTACK_URL" | "PRISMIC_WRITE_TOKEN" | "GOOGLE_INDEXING_KEY_JSON" | "ADMIN_LOGIN_PASSWORD" | "CF_ANALYTICS_API_TOKEN">> {}
}
